...
HD_PWD='C:/Users/usuario_local/Downloads/Lab06/mi_proyecto/workspace/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSMulticycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPSMulticycle.tcl
