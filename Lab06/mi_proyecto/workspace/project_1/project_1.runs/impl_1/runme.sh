...
HD_PWD='C:/Users/usuario_local/Downloads/Lab06/mi_proyecto/workspace/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSMulticycle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPSMulticycle.tcl -notrace
