...
BEGIN
divInstance : divisor_ent PORT MAP (clk, rst,dividendo, divisor, inicio, fin,
cociente_signal );
cociente <= cociente_signal;
conv_7segInstance: displays PORT MAP (rst, clk, cociente_signal(3 downto 0),
cociente_signal(7 downto 4), "0000", "0000", display, s_display );
END divArch;