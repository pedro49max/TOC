...
HD_PWD='E:/TOC/lab3_extra/lab3_extra.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log treeComparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source treeComparator.tcl
