...
HD_PWD='E:/TOC/lab3_extra/lab3_extra.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log treeComparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source treeComparator.tcl -notrace
